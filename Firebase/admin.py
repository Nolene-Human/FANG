...
def admin_login():
    ...
    cred = credentials.Certificate('C:\Users\Nina\Desktop\key\family-area-network-firebase-adminsdk-okm5h-984dd4e918.json')
...
#--------------------------------------------------------------------------------
# KEEP THIS IF LATER WE NEED TO CREATE AN ADMIN LOGIN # HIGHLY UNLIKELY#
